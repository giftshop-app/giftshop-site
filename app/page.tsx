        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="mb-8 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-rose-100 px-4 py-2 border border-rose-200">
              ...
              <span className="text-sm font-medium text-rose-700">Now available for all Shopify stores</span>
            </div>
          </div>
            ...
            {Array.from({ length: 8 }).map((_, i) => (
              ...
              >
                <div className="px-4 text-center">
                  <span className="text-sm font-semibold text-gray-700">Brand {i + 1}</span>
                </div>
              </div>
            ))}
          </div>
